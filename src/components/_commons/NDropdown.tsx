...
const NDropdown = <T extends object>({
  value,
  options = [],
  ...
  return (
    ...
    >
      ...
      <div
        className={`absolute z-10 w-full max-h-60 overflow-auto bg-white border rounded-sm shadow-lg transition-all duration-300 ease-in-out ${
          isOpen
