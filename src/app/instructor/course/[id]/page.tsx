...
const CourseEdit: React.FC = () => {
  ...
  if (loading) {
    return <div className="flex items-center justify-center h-[300px]"><Loader/></div>;
  }

  return (
    <div className=" h-[calc(100vh-130px)] bg-gray-1 rounded-sm grid grid-cols-1 md:grid-cols-10 gap-4 p-4">
      ...
      <div className="md:col-span-8 bg-white h-full max-h-full rounded-sm flex flex-col overflow-auto relative">
        <div className="text-title-sm font-semibold px-4 py-2 sticky top-0 z-10 bg-white">
          {currentStep?.label}
        </div>
        <div className="p-4">
